...
- 貨運司機或快遞員： 在星際間運輸貨物。
- 賽車手： 在驚險的賽道上挑戰極限。
- **基地建設與製造:** 這是 1.0 版本最受期待的系統。截至 2026 年，基地建設 T0 已進入內部測試階段。玩家將可以建造屬於自己的基地，利用資源和藍圖（4.8 已開始保存藍圖進度）進行規模化生產。

### 遊戲內公會 (NPC 組織)

為了讓你的職業生涯更有目標感，遊戲中設立了多個官方的 NPC 公會，並已在 4.8 版本中初步實裝了公會聲望與獎勵系統。
