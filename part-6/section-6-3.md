...
| **Nyx (尼克斯)**      | 部分由 InterSec 派系管理 | Delamar, Nyx I-III                    | InterSec Defense Solutions、犯罪集團、獨立定居者   | 中期遊戲                | 已於 Alpha 4.4.0/4.8.0 階段性加入。這裡有豐富的採礦內容與土地爭奪敘事，是 1.0 計畫中的核心星系之一。        |
| **Castra (卡斯特拉)** | 合法                     | Cascom, Castra I-II                   | UEE 海軍                                            | 中期遊戲                | 一個以軍事為主的合法星系，目前正處於 1.0 版本的最後構建階段。                                                     |
| **Terra (泰拉)**      | 合法                     | Terra, Pike, Aero, Gen                | UEE 政府、富裕階層                                  | 後期遊戲 (高端內容中心) | 一個富饒、繁華的星系，被譽為帝國的「璀璨明珠」。它是 1.0 版本的終極目標與高端內容中心。                           |

### 你的故事與成長

- **1.0 主線故事:** 1.0 版本將包含一個長達約 30 小時的主線故事。它就像一個大型的教學任務，將引導你穿越這五個星系。
